...
Solidity 在 OS X 下构建，必须 [安装 Homebrew](<http://brew.sh)
包管理器来安装依赖。
如果你想从头开始，这里是[卸载 Homebrew 的方法](https://github.com/Homebrew/homebrew/blob/master/share/doc/homebrew/FAQ.md#how-do-i-uninstall-homebrew>)
